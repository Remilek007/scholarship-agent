...
export interface ApplicationAnswer { id:string; applicationId:string; field:string; answer:string; aiPolicy:"allowed"|"limited"|"prohibited"|"unknown"; reviewed:boolean; }
