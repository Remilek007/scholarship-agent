...
function extractEligibility(text:string){const lower=text.toLowerCase();const internationalStudents=/international students|international applicants|all nationalities|any nationality|open to international/.test(lower);const excludedInternational=/not open to international students|international students are not eligible|international applicants are not eligible|international candidates are not eligible/.test(lower);return{internationalStudents:internationalStudents&&!excludedInternational?true:excludedInternational?false:undefined,eligibleNationalities:internationalStudents&&!excludedInternational?["international"]:undefined,excludedNationalities:excludedInternational?["international"]:undefined};}
